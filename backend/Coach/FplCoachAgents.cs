    ...
    [
        ...
        new()
        {
            ...
            Prompt = """
                ...
                Do not recommend buying, selling, holding, captaining, or benching a player. Transfer decisions belong to TransferAgent. Return concise schedule findings to FplCoachAgent.
                """
        },
        new()
        {
